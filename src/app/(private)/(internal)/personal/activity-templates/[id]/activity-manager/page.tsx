...
import TodoListProvider from './_providers/todo-list.provider'
	...
	return (
		<Frame className='gap-5 sm:gap-4'>
			...
			<FrameBody className='sm:gap-4'>
				<TodoListProvider initialValue={activityTemplate.activities ?? []}>
					<section className='flex justify-between'>
						<Modal
							title='Nueva actividad'
							description='Agrega una nueva actividad para usar en tus optimizaciones. Ten en cuenta que algunos campos son opcionales.'
