...
const stepVariants = cva(
	'flex break-words [&_[step-box]]:font-medium  [&_[step-box=disable]]:text-foreground/70 [&_[step-box=completed]]:text-primary-foreground [&_[step-box=current]]:text-primary [&_[step-box=current]]:bg-background  ',
	{
		variants: {
			variant: {
				default:
					'[&_[step-bar-bg=disable]]:before:bg-slate-100 [&_[step-bar-bg=current]]:before:bg-slate-100 [&_[step-bar-bg=completed]]:before:bg-primary [&_[step-box=current]]:border-2 [&_[step-box=current]]:border-primary [&_[step-box=completed]]:bg-primary   [&_[step-box=disable]]:bg-slate-100 [&_[step-box=error]]:bg-destructive [&_[step-box=error]]:text-destructive-foreground  ',
			},
			size: {
